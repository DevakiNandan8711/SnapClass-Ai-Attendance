...
from pipelines.face_pipelines import predict_attendance
...
def teacher_dashboard():
    ...
    elif st.session_state.current_teacher_tab == "manage subjects":
...
def teacher_tab_take_attendance():
    ...
    subject_options = {f"{s['name']}": s['subject_id'] for s in subjects}
...
def teacher_screen_login():
        ...
        st.space()
        st.space()
        teacher_username = st.text_input("enter username", placeholder='nandan')
...
def teacher_screen_register():
        ...
        st.space()
        st.space()
        teacher_username = st.text_input("enter username", placeholder='nandan87')
        
        teacher_name = st.text_input("enter name", placeholder='nandan')
